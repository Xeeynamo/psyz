...
static const char gl33_vertex_shader[] = {
    ...
    "    texPage = uvec2(tex.zw);\n"
    "    uint tpage = texPage.y;\n"
...
static const char gl33_fragment_shader[] = {
    ...
    "    return vec2(\n"
    "        float((clut & 63u) << 4u) * INV_1024,\n"
    "        float(clut >> 6u) * INV_512);\n"
    "}\n"
    "\n"
    "void main() {\n"
    "    uint clut = texPage.x;\n"
    ...
    "        }\n"
    "        float colorIdx = floor(colIdx * 256.0) * INV_1024;\n"
